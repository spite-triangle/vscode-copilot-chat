...
exports.wellKnownLanguages = void 0;
exports.getLanguage = getLanguage;
exports.getLanguageForResource = getLanguageForResource;
/*---------------------------------------------------------------------------------------------
...
exports.wellKnownLanguages = new Map(Object.entries(languages).map(([languageId, info]) => [languageId, { languageId, ...info }]));
...
function _getLanguage(languageId) {
    return (exports.wellKnownLanguages.get(languageId.toLowerCase())
        ?? { languageId, lineComment: { start: '//' } });
}
function getLanguageForResource(uri) {
    const ext = (0, resources_1.extname)(uri).toLowerCase();
    for (const info of exports.wellKnownLanguages.values()) {
