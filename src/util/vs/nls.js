...
const nls_messages_1 = require("./nls.messages");
// eslint-disable-next-line local/code-import-patterns
var nls_messages_2 = require("./nls.messages");
...
const isPseudo = (0, nls_messages_1.getNLSLanguage)() === 'pseudo' || (typeof document !== 'undefined' && document.location && typeof document.location.hash === 'string' && document.location.hash.indexOf('pseudo=true') >= 0);
