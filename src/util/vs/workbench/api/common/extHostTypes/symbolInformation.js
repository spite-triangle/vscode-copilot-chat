...
exports.SymbolInformation = exports.SymbolTag = exports.SymbolKind = void 0;
...
let SymbolInformation = SymbolInformation_1 = class SymbolInformation {
    ...
    constructor(name, kind, rangeOrContainer, locationOrUri, containerName) {
        ...
        if (locationOrUri instanceof location_1.Location) {
            this.location = locationOrUri;
        }
        else if (rangeOrContainer instanceof range_1.Range) {
            this.location = new location_1.Location(locationOrUri, rangeOrContainer);
        }
