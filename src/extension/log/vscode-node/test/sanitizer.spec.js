...
const loggingActions_1 = require("../loggingActions");
(0, vitest_1.suite)('Sanitizer', () => {
    (0, vitest_1.test)('Should scrub ids', () => {
        const inputs = [
        ...
        vitest_1.assert.deepEqual(inputs.map(loggingActions_1.sanitizeValue), expected);
    });
});
//# sourceMappingURL=sanitizer.spec.js.map