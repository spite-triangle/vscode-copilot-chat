...
function fileScore(snippets, partialFileName) {
    ...
    (0, vitest_1.assert)(false, 'Expected valid file name');
}
(0, vitest_1.suite)('Similar files with subset matching Test Suite', function () {
    /**
     ...
     * methods.
     */
    (0, vitest_1.test)('Only current method is considered as part of reference tokens', async function () {
        const file0 = `
        ...
        (0, vitest_1.assert)(fileScore(oldScores, 'file3') > fileScore(oldScores, 'file2') &&
        ...
        (0, vitest_1.assert)(fileScore(newScores, 'file2') > fileScore(newScores, 'file1') &&
     ...
     */
    (0, vitest_1.test)('Methods are not penalized for being supersets of the reference chunk', async function () {
        const file0 = `
            public static class TestClass
            {
        ...
        (0, vitest_1.assert)(fileScore(oldScores, 'file2') > fileScore(oldScores, 'file1') &&
        ...
        (0, vitest_1.assert)(fileScore(newScores, 'file1') > fileScore(newScores, 'file2') &&
     ...
     * methods.
     */
    (0, vitest_1.test)('Only current class is considered as part of reference tokens', async function () {
        const file0 = `
        ...
        // We expect the new way to prefer the second file because it contains the most tokens that match
        // the method enclosing the caret.
        (0, vitest_1.assert)(fileScore(newScores, 'file2') > fileScore(newScores, 'file3') &&
...
//# sourceMappingURL=subsetMatching.spec.js.map