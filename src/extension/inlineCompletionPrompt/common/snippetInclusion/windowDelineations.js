...
exports.getBasicWindowDelineations = getBasicWindowDelineations;
exports.getIndentationWindowsDelineations = getIndentationWindowsDelineations;
const manipulation_1 = require("../indentation/manipulation");
const parsing_1 = require("../indentation/parsing");
/**
 ...
 * @param lines
 */
function getIndentationWindowsDelineations(lines, languageId, minLength, maxLength) {
    ...
    const labeledTree = (0, manipulation_1.clearLabels)((0, parsing_1.parseTree)(lines.join('\n'), languageId));
    (0, manipulation_1.visitTree)(labeledTree, node => {
        if (node.type === 'blank') {
        ...
        for (let b = 0; b < node.subs.length; b++) {
            ...
            if (lengthFromAToBInclusive > maxLength) {
                ...
                const endLineTrimmedForBlanks = lastBThatWasntABlank === b ? endLine : getEndLine(lastBThatWasntABlank, startLine);
        ...
        if (a < node.subs.length) {
            ...
            const endLineTrimmedForBlanks = a === -1 ? endLine : node.subs[lastBThatWasntABlank].label.firstLineAfter;
...
//# sourceMappingURL=windowDelineations.js.map