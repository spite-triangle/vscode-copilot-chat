...
var TerminalIntent_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.TerminalIntent = void 0;
...
const terminal_1 = require("../../prompts/node/panel/terminal");
let TerminalIntent = class TerminalIntent {
    static { TerminalIntent_1 = this; }
    static { this.ID = "terminal" /* Intent.Terminal */; }
...
exports.TerminalIntent = TerminalIntent;
exports.TerminalIntent = TerminalIntent = TerminalIntent_1 = __decorate([
    __param(0, instantiation_1.IInstantiationService),
    __param(1, endpointProvider_1.IEndpointProvider)
], TerminalIntent);
let TerminalIntentInvocation = class TerminalIntentInvocation {
    ...
    async buildPrompt(promptContext, progress, token) {
        ...
        const renderer = promptRenderer_1.PromptRenderer.create(this.instantiationService, this.endpoint, terminal_1.TerminalPrompt, {
            promptContext,
            osName,
            shellType,
