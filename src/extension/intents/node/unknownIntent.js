...
let UnknownIntent = class UnknownIntent {
    static { UnknownIntent_1 = this; }
    static { this.ID = "unknown" /* Intent.Unknown */; }
    constructor(instantiationService, endpointProvider) {
        this.instantiationService = instantiationService;
        this.endpointProvider = endpointProvider;
        this.id = UnknownIntent_1.ID;
        this.locations = [commonTypes_1.ChatLocation.Editor, commonTypes_1.ChatLocation.Panel];
        this.description = l10n.t('Intent of this command is unclear or is not related to information technologies');
    ...
    async invoke(invocationContext) {
        ...
        return this.instantiationService.createInstance(genericPanelIntentInvocation_1.GenericPanelIntentInvocation, this, location, endpoint, undefined, documentContext);
    }
};
exports.UnknownIntent = UnknownIntent;
exports.UnknownIntent = UnknownIntent = UnknownIntent_1 = __decorate([
    __param(0, instantiation_1.IInstantiationService),
    __param(1, endpointProvider_1.IEndpointProvider)
], UnknownIntent);
//# sourceMappingURL=unknownIntent.js.map