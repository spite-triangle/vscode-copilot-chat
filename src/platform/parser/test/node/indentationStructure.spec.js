...
const abstractText_1 = require("../../../editing/common/abstractText");
const indentationStructure_1 = require("../../node/indentationStructure");
const parserImpl_1 = require("../../node/parserImpl");
const markers_1 = require("./markers");
(0, vitest_1.describe)('getStructure', () => {
    (0, vitest_1.afterAll)(() => (0, parserImpl_1._dispose)());
    function treeToFlatList(node) {
        const result = [];
    ...
    async function srcWithAnnotatedStructure(source, languageId, formattingOptions) {
        const structure = await (0, indentationStructure_1.getStructureUsingIndentation)(new abstractText_1.StringTextDocument(source), languageId, formattingOptions);
        const flatList = structure ? treeToFlatList(structure) : [];
        return (0, markers_1.insertRangeMarkers)(source, flatList);
    }
    (0, vitest_1.describe)('indentation structure', () => {
        (0, vitest_1.test)('csharp file', async () => {
            const source = (0, outdent_1.outdent) `
				...
				`;
            (0, vitest_1.expect)(await srcWithAnnotatedStructure(source, 'csharp', {
                tabSize: 4,
                insertSpaces: false,
        ...
        (0, vitest_1.test)('issue #1034', async () => {
            const source = (0, outdent_1.outdent) `
				if(something) {
					...
					console.log('a line');
				`;
            (0, vitest_1.expect)(await srcWithAnnotatedStructure(source, 'plaintext', {
                tabSize: 4,
                insertSpaces: false,
            })).toMatchInlineSnapshot(`
				"<FOLD>if(something) {
        ...
        (0, vitest_1.test)('issue #6614', async () => {
            const source = (0, outdent_1.outdent) `
				<!-- Copyright (C) Microsoft Corporation. All rights reserved. -->
				<!DOCTYPE html>
				<html>
        ...
        (0, vitest_1.test)('issue #12306', async () => {
            const source = (0, outdent_1.outdent) `
				/*---------------------------------------------------------------------------------------------
				*  Copyright (c) Microsoft Corporation. All rights reserved.
				*  Licensed under the MIT License. See License.txt in the project root for license information.
				...
				*/
				...
				`;
            (0, vitest_1.expect)(await srcWithAnnotatedStructure(source, 'css', {
                tabSize: 4,
                insertSpaces: false,
            })).toMatchInlineSnapshot(`
				"<LINE>/*---------------------------------------------------------------------------------------------
...
//# sourceMappingURL=indentationStructure.spec.js.map